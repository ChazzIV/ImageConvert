...
inicioRutas.post('/update/:id', (req: any, res: any, next) => {
    ...
    // }
        ...
        //query insert 
        connection.query('insert into product_thumbs set ? ', form_data, (err: any, result: any) => {
            if(err){
                res.render('pages/edit', {
                    id: req.params.id,
...
inicioRutas.get('/add', (req: any, res: any, next) => {
